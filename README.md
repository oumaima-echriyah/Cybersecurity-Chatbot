...
Built Docker images for the Flask backend and ran them as containers to ensure consistent and portable environments.

Wrote Dockerfiles, specifying dependencies and build instructions.

Kubernetes Deployment:

Deployed Flask backend in Kubernetes pods within a Minikube cluster.

Developed Deployment YAML files for Flask and Angular with a replica count of 2 for high availability.

Configured Service YAML files using the nodeport service type to expose the applications externally.

Validated deployments by checking pod status and ensuring services were accessible.

CI/CD:

Jenkins Pipeline:

Designed and implemented a Jenkins pipeline to automate the build, test, and deployment processes.

Authored a Jenkinsfile to:

Clone the GitHub repository containing Flask and Angular code.

Build and push Docker images to Docker Hub.

Deploy pods into the Minikube cluster using kubectl commands.


<img width="1237" alt="Screenshot 2025-01-08 at 21 02 36" src="https://github.com/user-attachments/assets/42290a32-f9d2-4935-a0ed-23dd38e9be5e" />

<img width="1108" alt="Screenshot 2025-01-08 at 21 02 47" src="https://github.com/user-attachments/assets/b9436355-5fe7-41d6-aedd-2ff5100033db" />
